...
7. Run the script `create_input_files.py` (found in the `scripts` directory) with the command line parameters runs_letter and the run directories to be created. Example: `./create_input_files.py U 1-100'.
