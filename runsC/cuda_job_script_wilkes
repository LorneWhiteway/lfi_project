#!/bin/bash
#!
#! Example SLURM job script for Wilkes3 Ampere (AMD EPYC 7763, ConnectX-6, A100)
...
#! Added by LW in attempt to fix memory issues with run 3 (see my notes p. 72)
#SBATCH --mem=36000
